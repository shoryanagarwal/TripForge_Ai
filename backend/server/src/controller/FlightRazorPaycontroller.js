const FlightRazorPayService=require('../service/FlightRazorPay.js');
const razorPayService=new FlightRazorPayService();


class FlightRazorPayController{
...
module.exports=FlightRazorPayController;